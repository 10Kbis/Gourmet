...
public class ServeurModification extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal
     * @param prefillServeur
     */
    public ServeurModification(java.awt.Frame parent, boolean modal, Serveur prefillServeur) {
        this(parent, modal);
        
        textFieldNom.setText(prefillServeur.getNom());
        textFieldPrenom.setText(prefillServeur.getPrenom());
        textFieldCarteID.setText(prefillServeur.getCarteID());
        textFieldLogin.setText(prefillServeur.getLogin());
        passwordField.setText(prefillServeur.getPassword());
    }
    ...
    private void buttonOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonOkActionPerformed
        ...
        serveur.setPassword(new String(passwordField.getPassword()));
